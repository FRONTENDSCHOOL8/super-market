...
//     point: getPriceNumber(findDataObj.price.result) * 0.01,
//   };
// };
...
//   getNode('.cart-product .plus').addEventListener('click', () =>
...
//   //     return;
//   //   }
//   //   getNode('.cart-product__count__result').innerText = count;
//   // };

//   // getNode('.cart-product__count__change.minus').addEventListener(
//   //   'click',
//   //   handleProductCount
//   // );
//   // getNode('.cart-product__count__change.plus').addEventListener(
//   //   'click',
//   //   handleProductCount
//   // );
